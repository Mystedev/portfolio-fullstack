        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-6 animate-slide-up" style={{ animationDelay: '1s' }}>
            <a
              ...
              className="text-black hover:text-black transition-all transform hover:scale-125 hover:rotate-12"
            >
              <Github size={28} />
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 hover:text-blue-600 transition-all transform hover:scale-125 hover:rotate-12"
            >
              <Linkedin size={28} />
            </a>
            <a
              href={`mailto:${mockPersonalInfo.email}`}
              className="text-red-600 hover:text-red-600 transition-all transform hover:scale-125 hover:rotate-12"
            >
              <Mail size={28} />
            </a>
          </div>
